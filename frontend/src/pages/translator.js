                    ...
                    <div className="recognizer-left-column">
                        ...
                        <div className="recognizer-camera-container relative">
                            <video
                                ...
                                autoPlay
                                playsInline
                                className={`recognizer-video recognizer-video-${wsStatus}`}
                            ></video>
                            <canvas
                                ref={canvasRef2}
                            ...
                            <div className="recognizer-camera-controls">
                                <button
                                    onClick={switchModel}
                                    className="recognizer-camera-button"
                                    title="Switch Model"
                                >
                            ...
                            <div className="recognizer-status-key-list">
                                <div className="recognizer-status-key-column">
                                    {statusKey.slice(0, 2).map(({ status, color, description }) => (
                                        <div key={status} className="recognizer-status-key-item">
                                            <span
                                                className="recognizer-status-key-color"
                                                style={{ backgroundColor: color }}
                                            ></span>
                                            <span className="recognizer-status-key-text">
                                                <strong>{status.charAt(0).toUpperCase() + status.slice(1)}:</strong> {description}
                                            </span>
                                        </div>
                                    ))}
                                </div>
                                <div className="recognizer-status-key-column">
                                    {statusKey.slice(2).map(({ status, color, description }) => (
                                        <div key={status} className="recognizer-status-key-item">
                                            <span
                                                className="recognizer-status-key-color"
                                                style={{ backgroundColor: color }}
