...
model = hub.load("https://www.kaggle.com/models/sayannath235/american-sign-language/TensorFlow2/american-sign-language/1")
        ...
        if results.multi_hand_landmarks:
            for handLandmarks in results.multi_hand_landmarks:
                ...
                if currentTime - lastPredictionTime > cooldownDuration:
                    ...
                    inputData = np.expand_dims(normalized_img, axis=0)  
