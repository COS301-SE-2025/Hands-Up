...
from preProcessData import load_data 

PROCESSED_PATH = 'processedDataset' 
MODEL_PATH = 'wordsModel.h5'             
NORMALIZATION_PARAMS_PATH = 'normalizationParams.npy' # Path for saving/loading normalization parameters
LABEL_MAP_PATH = 'labelMap.pickle'           # Path for saving/loading the action-label mapping
