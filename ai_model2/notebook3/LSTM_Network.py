...
PROCESSED_PATH = 'D:\capstone\msasl_augumented' # Base path for your processed keypoint data
...
TARGET_ACCURACY_THRESHOLD = 0.80 # 85% accuracy threshold as requested
...
NEW_ACTIONS_PER_STEP_MIN = 5# Minimum new actions to add per step
NEW_ACTIONS_PER_STEP_MAX = 10# Maximum new actions to add per step
