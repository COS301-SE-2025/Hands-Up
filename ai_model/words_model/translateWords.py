...
model = tf.keras.models.load_model('wordsModel.keras')
...
while cap.isOpened():
    ...
    if not collecting:
        cv2.putText(img, "Press 's' to sign", (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
    else:
        cv2.putText(img, f"Collecting frames... {frameCounter}/30", (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
