...
# IMPORTANT: This should now point to the CSV generated by create_personal_dataset_csv.py (your 77 words)
PROCESSED_DATA_CSV = 'wlasl_77_words_demo_processed.csv'
...
if __name__ == "__main__":
    ...
    final_processed_df.to_csv('wlasl_77_words_personal_final_processed_data_augmented_seq90.csv', index=False)
    print("\nFinal processed data metadata saved to 'wlasl_77_words_personal_final_processed_data_augmented_seq90.csv'")
