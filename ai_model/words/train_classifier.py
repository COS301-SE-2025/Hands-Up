...
# IMPORTANT: This now points to the CSV generated by data_preprocessor.py for your 77 words
...
# --- Model Hyperparameters (ADJUSTED FOR 77 WORDS) ---
# These parameters are increased significantly to handle the larger vocabulary
LSTM_UNITS = 192 # Increased capacity from 128
DENSE_UNITS = 256 # Increased capacity from 192
DROPOUT_RATE = 0.56 # Increased for more aggressive regularization
...
if __name__ == "__main__":
    ...
    checkpoint_filepath = os.path.join(MODEL_SAVE_DIR, 'best_sign_classifier_model_77_words_seq90.keras')
