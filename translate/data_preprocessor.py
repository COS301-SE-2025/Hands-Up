...
# IMPORTANT: This should now point to the CSV generated by create_personal_dataset_csv.py (your 30 words)
PROCESSED_DATA_CSV = 'wlasl_30_words_personal_processed.csv' # <-- CHANGED TO 30 WORDS
...
if __name__ == "__main__":
    ...
    final_processed_df.to_csv('wlasl_20_words_final_processed_data_augmented_seq90.csv', index=False) # <-- CORRECTED OUTPUT CSV NAME
    print("\nFinal processed data metadata saved to 'wlasl_20_words_final_processed_data_augmented_seq90.csv'") # <-- UPDATED PRINT MESSAGE
