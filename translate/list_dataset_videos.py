...
# --- Configuration ---
# This should now point to the CSV generated by wlasl_parser.py for your 20 words
...
print(f"--- Listing Video Files and Sign Names for Dataset: {PROCESSED_DATA_CSV} (20 Words) ---") # <-- UPDATED PRINT

if not os.path.exists(PROCESSED_DATA_CSV):
    print(f"Error: Processed data CSV not found at {PROCESSED_DATA_CSV}.")
    print("Please ensure wlasl_parser.py has been run for your 20-word list.") # Updated error message
    exit()
