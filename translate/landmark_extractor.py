...
# --- Configuration ---
# Path to your personal 30-words CSV (Generated by create_personal_dataset_csv.py)
PROCESSED_DATA_CSV = 'wlasl_30_words_personal_processed.csv' # <-- CHANGED THIS LINE
...
MAX_VIDEOS_FOR_TEST = None # Should be None to process the full 30 words
...
if __name__ == "__main__":
    ...
    if not os.path.exists(PROCESSED_DATA_CSV):
        print(f"Error: Processed data CSV not found at {PROCESSED_DATA_CSV}. Please run create_personal_dataset_csv.py first.") # Updated error message
        exit()
