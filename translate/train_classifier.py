...
# IMPORTANT: This now points to the CSV generated by data_preprocessor.py for your 40 words
PROCESSED_DATA_CSV = 'wlasl_40_words_personal_final_processed_data_augmented_seq90.csv' # Changed to 40 words
...
# --- Model Hyperparameters (These are the values you had set for 30 words) ---
# Note: For a significant vocabulary increase to 40 words, these might eventually
# need further tuning (e.g., increasing LSTM_UNITS, DENSE_UNITS, adjusting DROPOUT_RATE, patience)
# if you experience underfitting or suboptimal performance. For now, keeping as per request.
LSTM_UNITS = 128
DENSE_UNITS = 192
DROPOUT_RATE = 0.55
...
if __name__ == "__main__":
    ...
    if not os.path.exists(PROCESSED_DATA_CSV):
        ...
        print("Please ensure data_preprocessor.py has been run to create this file (for your 40-word list, sequence 90).") # Updated message
        exit()
    ...
    print(f"Number of unique classes: {num_classes}") # Should be 40
    ...
    checkpoint_filepath = os.path.join(MODEL_SAVE_DIR, 'best_sign_classifier_model_40_words_seq90.keras') # Changed model save filename
